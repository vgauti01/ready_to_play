  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        <h4 className="font-bold text-slate-800 text-sm mb-1 leading-snug group-hover:text-decathlon-primary transition-colors">
          {product.title}
        </h4>

        {/* Prix et Étoiles */}
        <div className="mt-auto pt-2 flex items-end justify-between">
          <span className="bg-decathlon-highlight text-slate-900 font-black px-2 py-1 text-lg rounded-sm shadow-sm transform -skew-x-12">
            {product.price}
          </span>
